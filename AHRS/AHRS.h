...
#define GYRO_SAMPLES                100                                // Number of samples to calculate gyro bias errors
...
#define MAG_FREQ                    3                                  // Mag sample compared to accl/gyro sample 
...
//Mode
#define	NORM_W_GS                   0x00
#define	NORM_WO_GS                  0x01

//Calibration Values
#define	ACC_XS                      0.966f
#define	ACC_YS                      0.956f
#define	ACC_ZS                      0.961f
#define	ACC_XB                      -0.00483f
#define	ACC_YB                      -0.00478f
#define	ACC_ZB                      0.0480f
#define	MAG_XS                      1.0f
#define	MAG_YS                      1.0f
#define	MAG_ZS                      1.0f
#define	MAG_XB                      0.0f
...
public:
	AHRS();
        void Init(byte,byte,byte,float);
        void Start();
        void Stop();
        void AHRS_ISR();
        void Update();
        void GetEulerAnglesRad(Euler*);
        void GetEulerAnglesDeg(Euler*);
        void Acclerometer(Vector*);
        void Magnetometer(Vector*);
...
private:
        boolean _Running,_Ready,_GyroSampleMode,_GetNewSample,_GetNewMagSample;
        int _i,_i2cdata[I2C_LENGTH],_SampleCounter,_MagCounter;
        float _DT,_MagDT,_GyroDriftDt,_HalfDT;
